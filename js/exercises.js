...
//---------тоже самое без for сделанное методом map
...
console.log(composeMessage.call(orders[1], 2));
console.log(composeMessage.call(orders[2], 3));
...
// console.log(pizzaPalaceComposer('поли'));
